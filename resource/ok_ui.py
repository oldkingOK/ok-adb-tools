...
# Form implementation generated from reading ui file '.\resource\ok-adb-tools.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table_devices.setStyleSheet("background-color: rgba(255, 255, 255, 200);font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.comboBox_open_apk.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.pushButton_open_apk.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.pushButton_adb_install.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.label_package_name.setStyleSheet("background-color: rgba(230, 230, 230, 200);font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.comboBox_IDA_V.setStyleSheet("background-color: rgba(255, 255, 255, 200);font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.pushButton_dbgsrv.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.textBrowser_dbgsrv_output.setGeometry(QtCore.QRect(10, 280, 271, 151))
        self.textBrowser_dbgsrv_output.setStyleSheet("background-color: rgba(255, 255, 255, 200);")
        ...
        self.label_IDA_output.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.label_jdbc_output.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.textBrowser_jdbc_output.setGeometry(QtCore.QRect(10, 460, 271, 141))
        self.textBrowser_jdbc_output.setStyleSheet("background-color: rgba(255, 255, 255, 200);")
        self.textBrowser_jdbc_output.setObjectName("textBrowser_jdbc_output")
        self.label_logcat = QtWidgets.QLabel(self.centralwidget)
        self.label_logcat.setGeometry(QtCore.QRect(290, 260, 131, 16))
        self.label_logcat.setStyleSheet("background-color: rgba(255, 255, 255, 200);font: 25 9pt \"微软雅黑 Light\";")
        self.label_logcat.setObjectName("label_logcat")
        self.textBrowser_logcat = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser_logcat.setGeometry(QtCore.QRect(290, 280, 601, 321))
        self.textBrowser_logcat.setStyleSheet("background-color: rgba(255, 255, 255, 200);")
        self.textBrowser_logcat.setObjectName("textBrowser_logcat")
        self.label_DeviceInfo = QtWidgets.QLabel(self.centralwidget)
        self.label_DeviceInfo.setGeometry(QtCore.QRect(10, 10, 71, 16))
        self.label_DeviceInfo.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.plainTextEdit_idapython.setStyleSheet("background-color: rgba(255, 255, 255, 200);font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.pushButton_copy.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        self.pushButton_copy.setObjectName("pushButton_copy")
        self.pushButton_start = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_start.setGeometry(QtCore.QRect(850, 130, 41, 31))
        self.pushButton_start.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        self.pushButton_start.setObjectName("pushButton_start")
        self.label_tip = QtWidgets.QLabel(self.centralwidget)
        self.label_tip.setGeometry(QtCore.QRect(690, 170, 151, 16))
        self.label_tip.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        self.label_tip.setObjectName("label_tip")
        self.pushButton_save = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_save.setGeometry(QtCore.QRect(850, 260, 41, 21))
        self.pushButton_save.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        self.pushButton_save.setObjectName("pushButton_save")
        self.pushButton_clear = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_clear.setGeometry(QtCore.QRect(750, 260, 41, 21))
        self.pushButton_clear.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.pushButton_refresh_device.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.pushButton_adb_uninstall.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        self.pushButton_adb_uninstall.setObjectName("pushButton_adb_uninstall")
        self.label_tip_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_tip_2.setGeometry(QtCore.QRect(700, 190, 131, 20))
        self.label_tip_2.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.pushButton_continue.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        ...
        self.checkBox_auto_clear.setGeometry(QtCore.QRect(670, 260, 71, 16))
        self.checkBox_auto_clear.setChecked(True)
        self.checkBox_auto_clear.setObjectName("checkBox_auto_clear")
        self.pushButton_copy_logcat = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_copy_logcat.setGeometry(QtCore.QRect(800, 260, 41, 21))
        self.pushButton_copy_logcat.setStyleSheet("font: 25 9pt \"微软雅黑 Light\";")
        self.pushButton_copy_logcat.setObjectName("pushButton_copy_logcat")
        self.widget_bg = QtWidgets.QWidget(self.centralwidget)
        self.widget_bg.setGeometry(QtCore.QRect(0, 0, 900, 650))
        self.widget_bg.setAutoFillBackground(False)
        self.widget_bg.setStyleSheet("background-image: url(:/bg/bg.jpg);")
        self.widget_bg.setObjectName("widget_bg")
        self.widget_bg.raise_()
        self.table_devices.raise_()
        self.comboBox_open_apk.raise_()
        self.pushButton_open_apk.raise_()
        self.pushButton_adb_install.raise_()
        self.label_package_name.raise_()
        self.comboBox_IDA_V.raise_()
        self.pushButton_dbgsrv.raise_()
        self.textBrowser_dbgsrv_output.raise_()
        self.label_IDA_output.raise_()
        self.label_jdbc_output.raise_()
        self.textBrowser_jdbc_output.raise_()
        self.label_logcat.raise_()
        self.textBrowser_logcat.raise_()
        self.label_DeviceInfo.raise_()
        self.plainTextEdit_idapython.raise_()
        self.pushButton_copy.raise_()
        self.pushButton_start.raise_()
        self.label_tip.raise_()
        self.pushButton_save.raise_()
        self.pushButton_clear.raise_()
        self.pushButton_refresh_device.raise_()
        self.pushButton_adb_uninstall.raise_()
        self.label_tip_2.raise_()
        self.pushButton_continue.raise_()
        self.checkBox_auto_clear.raise_()
        self.pushButton_copy_logcat.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_tip.setText(_translate("MainWindow", "点击启动之后，复制代码"))
        ...
        self.pushButton_copy_logcat.setText(_translate("MainWindow", "复制"))
import resource.qt_asset_rc
